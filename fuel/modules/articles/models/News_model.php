...
class News_model extends Base_posts_model {
    ...
    public $record_class = 'news_item'; // the name of the record class (if it can't be determined)
    ...
    {
        // $this->db->select('articles.id, articles.title, articles.published....'); uncomment and  change to the fields to be displayed
