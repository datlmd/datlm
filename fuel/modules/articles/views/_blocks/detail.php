<div class="section-row sticky-container">
    <div class="main-post">
        ...
        <p>One of the villagers, Kristina Halvorson from Adaptive Path, holds steadfastly to the notion that design can¡Çt be tested without real content:</p>
        <blockquote class="blockquote">
            I¡Çve heard the argument that ¡Èlorem ipsum¡É is effective in wireframing or design because it helps people focus on the actual layout, or color scheme, or whatever. What kills me here is that we¡Çre talking about creating a user experience that will (whether we like it or not) be DRIVEN by words. The entire structure of the page or app flow is FOR THE WORDS.
        </blockquote>
        ...
        <h3>Summing up, if the copy is diverting attention from the design it¡Çs because it¡Çs not up to task.</h3>
        <p>Typographers of yore didn't come up with the concept of dummy copy because people thought that content is inconsequential window dressing, only there to be used by designers who can¡Çt be bothered to read. Lorem Ipsum is needed because words matter, a lot. Just fill up a page with draft copy about the client¡Çs business and they will actually read it and comment on it. They will be drawn to it, fiercely. Do it the wrong way and draft copy can derail your design review.</p>
    </div>
...
<div class="section-row text-center">
    <a href="#" style="display: inline-block;margin: auto;">
        <img class="img-responsive" src="assets/theme/news/img/ad-2.jpg" alt="">
    </a>
</div>
<!-- ad -->
