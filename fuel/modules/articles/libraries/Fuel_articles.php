...
class Fuel_articles extends Fuel_advanced_module {

	public $name = "articles"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->articles->my_method()
	 */
}